...
namespace MVCProduct.Controllers
{
    ...
    {
        private DotConsoleEntities db = new DotConsoleEntities();
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,Rate")] ProductTable productTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,Rate")] ProductTable productTable)
        {
            if (ModelState.IsValid)
            {
